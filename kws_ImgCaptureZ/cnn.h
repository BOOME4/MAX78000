...
/*
 * This header file was automatically @generated for the kws20_demo network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 8,402,784 ops (8,345,600 macc; 54,496 comp; 2,688 add; 0 mul; 0 bitwise)
    ...
    Layer 8: 5,632 ops (5,632 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 169,728 bytes out of 442,368 bytes total (38.4%)
